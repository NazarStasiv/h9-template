---
description: Investigate a symptom and produce ranked hypotheses with evidence. Read-only — no fixes. Mirrors the bug-hunter skill in Cursor.
---
...
- Counter-evidence: <…>
- Proposed fix: <one line — for P2 / Cursor to execute>
...
- **No edits.** You investigate only. If you have an obvious fix,
  hand it to P2 via the "Proposed fix" field.
