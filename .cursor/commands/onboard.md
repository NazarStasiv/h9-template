---
description: Probe an unfamiliar repo and produce ONBOARDING.md. Run FIRST when the challenge gives you an existing repo to fix or extend. Uses the onboard-repo skill.
---

# /onboard — probe an unfamiliar repo

**Arguments:** $ARGUMENTS (`<repo path or .>` — defaults to `.` if empty)

Use the [onboard-repo skill](../skills/onboard-repo/SKILL.md) on
the path below.
