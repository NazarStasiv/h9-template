...
# /pr-merge — squash-merge a PR after gates
...
5. No new files under `.env`, `secrets/`, or other denied paths. Run:
   ```bash
...
The PR author addresses the gate failure and re-runs the
[reviewer skill](../skills/reviewer/SKILL.md) to re-issue
`OK_TO_MERGE: yes`.
