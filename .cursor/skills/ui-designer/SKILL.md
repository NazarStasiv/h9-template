...
You are acting as the UI Designer. You scaffold UI components using
...
7. **Screenshot in PR body.** Before opening a PR for a UI change,
   capture a screenshot via Playwright MCP or the
   [visual-pr-review command](../../commands/visual-pr-review.md).
