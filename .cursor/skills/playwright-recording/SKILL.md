...
1. Switch to QuickTime/OBS/built-in screen recording. Announce in
   team chat.
...
- Don't record manually with screen-recording tools as the first
  take — Playwright produces more consistent results and lets you
  re-run on a fix.
